...
| `bb pr list/get/comments/diff/statuses/activity` (PR 조회) | `read:repository:bitbucket`, `read:pullrequest:bitbucket` |
...
# 예: `bb pr<TAB>` -> list, create, merge, get, update, approve, ...
```
